...
// Interface for font data structure
interface FontData {
  categories: {
    [key: string]: {
      name: string;
...
async function loadFontData(): Promise<FontData> {
  try {
...
async function saveFontData(fontData: FontData): Promise<void> {
  try {
...
async function applyFontToSelection(fontName: string): Promise<void> {
